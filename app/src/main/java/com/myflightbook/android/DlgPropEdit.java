...
class DlgPropEdit extends Dialog implements android.view.View.OnClickListener, CrossFillDelegate {
    ...
    private double m_xFillValue;

    private DecimalEdit m_txtField;
    private AutoCompleteTextView m_txtStringVal;
    private CheckBox m_ck;

    DlgPropEdit(Context c, int id, PropertyListener pl, FlightProperty fp, double xFillValue) {
