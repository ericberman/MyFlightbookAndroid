...
public class ActAddApproach extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, ApproachDescription.ApproachNames);
		...
		adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, ApproachDescription.ApproachSuffixes);
		adapter.setDropDownViewResource(R.layout.samplequestion);
		s.setAdapter(adapter);		
		s.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
		    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) { 
		...
		adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, ApproachDescription.RunwayNames);
		adapter.setDropDownViewResource(R.layout.samplequestion);
		s.setAdapter(adapter);		
		s.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
		    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
		...
		adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, ApproachDescription.RunwayModifiers);
		adapter.setDropDownViewResource(R.layout.samplequestion);
		s.setAdapter(adapter);		
		s.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
		    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
		...
		if (rgAirports.length > 1)
		{
			...
			adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, rgAirports);
		...
		ckAddToTotals.setOnCheckedChangeListener(new OnCheckedChangeListener()  {
