...
public class CustomPropertyType extends SoapableObject  implements Comparable<CustomPropertyType>, Serializable, KvmSerializable {
	...
	public enum CFPPropertyType {cfpInteger, cfpDecimal, cfpBoolean, cfpDate,
		cfpDateTime, cfpString, cfpCurrency};
		
	enum cptPropID {pidIDPropType, pidType, pidTitle, pidFormatString, pidDescription, pidFlags, pidFavorite, pidPreviousValues}

	// known custom property types
	public static final int idPropTypeNightTakeOff = 73; 
	...
	public CFPPropertyType cptType = CFPPropertyType.cfpInteger;
	...
	public static CustomPropertyType cptFromId(int id, CustomPropertyType[] rgcpt)
	{
	...
	public int compareTo(CustomPropertyType cpt) {
	...
	public Object getProperty(int arg0) {
		...
		case pidPreviousValues:
			return new Vector<String>(Arrays.asList(this.PreviousValues));
		default:
			break;
		}
		return null;
	...
	public void getPropertyInfo(int arg0, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo pi) {
		cptPropID pid = cptPropID.values()[arg0];
		switch (pid)
		{
		case pidFavorite:
