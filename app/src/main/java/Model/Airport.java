...
public class Airport extends SoapableObject implements KvmSerializable, Comparable<Airport> {
	...
	public static final String szNavaidPrefix = "@";
    public static final String USAirportPrefix = "K";
    
    public enum AirportProp {pidAirportID, pidFacilityName, pidType, pidLatitude, pidLongitude, pidDistance}
    
    public static final int minNavaidCodeLength = 2;
    public static final int minAirportCodeLength = 3;
    public static final int maxCodeLength = 6; // because of navaids, now allow up to 5 letters.
    ...
    public static boolean IsUSAirport(String szcode)
    {
	...
	public static Airport[] AirportsFromRoute(String szRoute, Location loc)
	{
		...
		List<Airport> lstResults = new ArrayList<Airport>();
		...
		for (String s : rgCodes)
		{
			...
			if (Airport.IsUSAirport(s))
				sb.append(", '" + Airport.USPrefixConvenienceAlias(s) + "'");			
		}
	...
	{
		String[] rgCodes = SplitCodes(szRoute);
		ArrayList<Airport> al = new ArrayList<Airport>();
	...
	public static Airport getClosestAirport(Location loc)
	{
		if (loc == null)
			return null;
	...
	public static Airport[] getNearbyAirports(Location loc, double minLat, double minLong, double maxLat, double maxLong)
	{
