...
public class CountryCode {
	...
	{
		ID = 0;
		Prefix = LocaleCode = CountryName = "";
	}
	
	public CountryCode(Cursor c)
	{
		ID = c.getInt(c.getColumnIndex("id"));
		Prefix = c.getString(c.getColumnIndex("Prefix"));
		LocaleCode = c.getString(c.getColumnIndex("Locale"));
		CountryName = c.getString(c.getColumnIndex("CountryName"));
	...
	public static ArrayList<CountryCode> AllCountryCodes()
	{
		if (m_allCodes != null)
			return m_allCodes;
		
		m_allCodes = new ArrayList<CountryCode>();
	...
	public static CountryCode BestGuessForLocale(String szLocale)
	{
	...
	public static CountryCode BestGuessPrefixForTail(String szTail)
	{
