...
public class Aircraft extends SoapableObject implements KvmSerializable, Serializable, LazyThumbnailLoader.ThumbnailedItem
{
	...
	public enum AircraftProp {pidTailNumber, pidAircratID, pidModelID, pidInstanctTypeID, 
	...
	public final static String PREFIX_SIM = "SIM";
	public final static String PREFIX_ANON = "#";
