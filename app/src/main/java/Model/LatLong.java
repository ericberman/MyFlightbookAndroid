...
public class LatLong extends SoapableObject implements KvmSerializable {
	...
	public enum FPProp {pidLat, pidLng}
	...
	public static LatLong fromString(String sz)
	{
	...
	public void ToProperties(SoapObject so) {
		so.addProperty("Latitude", String.format("%.8f", this.Latitude));
		so.addProperty("Longitude", String.format("%.8f", this.Longitude));
	}
