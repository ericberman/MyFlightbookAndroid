...
object MFBConstants {
    ...
    const val DBVersionAirports = 49
    ...
    const val urlPrivacy = "https://%s/logbook/public/privacy.aspx?naked=1&%s"
    const val urlTandC = "https://%s/logbook/Public/TandC.aspx?naked=1&%s"
    ...
    const val urlTwitter = "https://twitter.com/myflightbook"
