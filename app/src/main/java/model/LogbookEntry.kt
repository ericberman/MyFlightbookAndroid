...
open class LogbookEntry : SoapableObject, KvmSerializable, Serializable, ThumbnailedItem {
    ...
    private fun init() {
        ...
        cNightLandings = 0
        cLandings = cNightLandings
        cFullStopLandings = cLandings
        cApproachPrecision = cFullStopLandings
        cApproachNonPrecision = cApproachPrecision
        cApproaches = cApproachNonPrecision
        hobbsStart = 0.0
        hobbsEnd = hobbsStart
        decDual = hobbsEnd
        decGrndSim = decDual
        decXC = decGrndSim
        decTotal = decXC
        decSimulatedIFR = decTotal
        decIMC = decSimulatedIFR
        decSIC = decIMC
        decPIC = decSIC
        decNight = decPIC
        decCFI = decNight
